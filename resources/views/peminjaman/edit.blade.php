...
<main class="container">
    <form action="{{ route('peminjaman.update', $loans->id) }}" method="post">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" name="notransaksi" id="notransaksi" value="{{ $loans->notransaksi }}">
        </div>
        <div class="mb-3">
            <label for="tgl_pinjam" class="form-label">tgl_pinjam</label>
            <input type="date" class="form-control" name="tgl_pinjam" id="tgl_pinjam" value="{{ $loans->tgl_pinjam }}">
        </div>
        <div class="mb-3">
            <label for="tgl_pengembalian" class="form-label">tgl_pengembalian</label>
            <input type="date" class="form-control" name="tgl_pengembalian" id="tgl_pengembalian" value="{{ $loans->tgl_pengembalian }}">
        </div>
        <div class="mb-3">
